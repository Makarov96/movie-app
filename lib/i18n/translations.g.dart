...
class _TranslationsHomeEn {
	...
	// Translations
	String get title => TranslationOverrides.string(_root.$meta, 'home.title', {}) ?? 'Kueski Movie App';
}
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			case 'home.title': return TranslationOverrides.string(_root.$meta, 'home.title', {}) ?? 'Kueski Movie App';
			default: return null;
		}
	}
}
