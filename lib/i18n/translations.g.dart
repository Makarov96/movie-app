...
///
/// Built on 2024-03-25 at 23:58 UTC
...
class Translations implements BaseTranslations<AppLocale, Translations> {
	...
	late final _TranslationsComponentEn component = _TranslationsComponentEn._(_root);
...
class _TranslationsComponentEn {
	...
	// Translations
	String get addFAvorites => TranslationOverrides.string(_root.$meta, 'component.addFAvorites', {}) ?? 'Add to favorites movies';
}
...
class _TranslationsEs implements Translations {
	...
	@override late final _TranslationsComponentEs component = _TranslationsComponentEs._(_root);
...
class _TranslationsComponentEs implements _TranslationsComponentEn {
	...
	// Translations
	@override String get addFAvorites => TranslationOverrides.string(_root.$meta, 'component.addFAvorites', {}) ?? 'Agregar a favoritos';
}
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'component.addFAvorites': return TranslationOverrides.string(_root.$meta, 'component.addFAvorites', {}) ?? 'Add to favorites movies';
...
extension on _TranslationsEs {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'component.addFAvorites': return TranslationOverrides.string(_root.$meta, 'component.addFAvorites', {}) ?? 'Agregar a favoritos';
