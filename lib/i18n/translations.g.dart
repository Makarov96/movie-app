...
class _TranslationsRecommendedEn {
  ...
  // Translations
  String get title =>
      TranslationOverrides.string(_root.$meta, 'recommended.title', {}) ??
      'Continue viewing';
  String get errorMessage =>
      TranslationOverrides.string(
          _root.$meta, 'recommended.errorMessage', {}) ??
      'Something went wrong, you could try to close and open the app again.';
  String get keepWatching =>
      TranslationOverrides.string(
          _root.$meta, 'recommended.keepWatching', {}) ??
      'No more';
  String get goToHome =>
      TranslationOverrides.string(_root.$meta, 'recommended.goToHome', {}) ??
      'Yes and go to home';
...
class _TranslationsDetailsEn {
  ...
  String get popularity =>
      TranslationOverrides.string(_root.$meta, 'details.popularity', {}) ??
      'Polularity:';
  String get votes =>
      TranslationOverrides.string(_root.$meta, 'details.votes', {}) ?? 'Votes:';
  String get votesAverage =>
      TranslationOverrides.string(_root.$meta, 'details.votesAverage', {}) ??
      'Votes Average:';
  String get originalTitle =>
      TranslationOverrides.string(_root.$meta, 'details.originalTitle', {}) ??
      'Original title:';
  String get releaseDate =>
      TranslationOverrides.string(_root.$meta, 'details.releaseDate', {}) ??
      'Release date:';
  String get originalLanguage =>
      TranslationOverrides.string(
          _root.$meta, 'details.originalLanguage', {}) ??
      'Original Language:';
  String get overview =>
      TranslationOverrides.string(_root.$meta, 'details.overview', {}) ??
      'Overview:';
}
...
class _TranslationsHomeEn {
  ...
  String get title =>
      ...
      'Kueski Movie';
  String get movies =>
      TranslationOverrides.string(_root.$meta, 'home.movies', {}) ?? 'Movies';
  String get playingMovies =>
      TranslationOverrides.string(_root.$meta, 'home.playingMovies', {}) ??
      'Playing Movies';
  String get errorMessage =>
      TranslationOverrides.string(_root.$meta, 'home.errorMessage', {}) ??
      'Something went wrong, you could try to close and open the app again.';
  String get favorites =>
      TranslationOverrides.string(_root.$meta, 'home.favorites', {}) ??
      'Favorites';
}
...
class _TranslationsRecommendedEs implements _TranslationsRecommendedEn {
  ...
  String get errorMessage =>
      TranslationOverrides.string(
          _root.$meta, 'recommended.errorMessage', {}) ??
      'Ha sucedido un error, puedes volver a cargar la aplicacion.';
  @override
  String get keepWatching =>
      TranslationOverrides.string(
          _root.$meta, 'recommended.keepWatching', {}) ??
...
class _TranslationsDetailsEs implements _TranslationsDetailsEn {
  ...
  @override
  String get votes =>
      TranslationOverrides.string(_root.$meta, 'details.votes', {}) ?? 'Votos:';
  @override
  String get votesAverage =>
      TranslationOverrides.string(_root.$meta, 'details.votesAverage', {}) ??
      'Media de votos:';
...
class _TranslationsHomeEs implements _TranslationsHomeEn {
  ...
  @override
  String get movies =>
      TranslationOverrides.string(_root.$meta, 'home.movies', {}) ??
      'Peliculas';
  @override
  String get playingMovies =>
      TranslationOverrides.string(_root.$meta, 'home.playingMovies', {}) ??
...
extension on Translations {
  dynamic _flatMapFunction(String path) {
    switch (path) {
      case 'recommended.title':
        return TranslationOverrides.string(
                _root.$meta, 'recommended.title', {}) ??
            'Continue viewing';
      case 'recommended.errorMessage':
        return TranslationOverrides.string(
                _root.$meta, 'recommended.errorMessage', {}) ??
            'Something went wrong, you could try to close and open the app again.';
      case 'recommended.keepWatching':
        return TranslationOverrides.string(
                _root.$meta, 'recommended.keepWatching', {}) ??
            'No more';
      case 'recommended.goToHome':
        return TranslationOverrides.string(
                _root.$meta, 'recommended.goToHome', {}) ??
            'Yes and go to home';
      case 'recommended.warningTitle':
        return TranslationOverrides.string(
                _root.$meta, 'recommended.warningTitle', {}) ??
            'Do you want to see this screen again?';
      ...
      case 'details.popularity':
        return TranslationOverrides.string(
            ...
            'Polularity:';
      case 'details.votes':
        return TranslationOverrides.string(_root.$meta, 'details.votes', {}) ??
            'Votes:';
      case 'details.votesAverage':
        return TranslationOverrides.string(
                _root.$meta, 'details.votesAverage', {}) ??
            'Votes Average:';
      case 'details.originalTitle':
        return TranslationOverrides.string(
                _root.$meta, 'details.originalTitle', {}) ??
            'Original title:';
      case 'details.releaseDate':
        return TranslationOverrides.string(
                _root.$meta, 'details.releaseDate', {}) ??
            'Release date:';
      case 'details.originalLanguage':
        return TranslationOverrides.string(
                _root.$meta, 'details.originalLanguage', {}) ??
            'Original Language:';
      case 'details.overview':
        return TranslationOverrides.string(
                _root.$meta, 'details.overview', {}) ??
            'Overview:';
      case 'home.title':
        return TranslationOverrides.string(_root.$meta, 'home.title', {}) ??
            'Kueski Movie';
      case 'home.movies':
        return TranslationOverrides.string(_root.$meta, 'home.movies', {}) ??
            'Movies';
      case 'home.playingMovies':
        return TranslationOverrides.string(
                _root.$meta, 'home.playingMovies', {}) ??
            'Playing Movies';
      case 'home.errorMessage':
        return TranslationOverrides.string(
                _root.$meta, 'home.errorMessage', {}) ??
            'Something went wrong, you could try to close and open the app again.';
      case 'home.favorites':
        return TranslationOverrides.string(_root.$meta, 'home.favorites', {}) ??
            'Favorites';
      default:
        return null;
    }
